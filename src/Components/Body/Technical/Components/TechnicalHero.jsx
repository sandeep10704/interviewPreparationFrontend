  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
         ...
         <div className="absolute bottom-1/4 left-0 w-[500px] h-[500px] bg-violet-500/5 blur-[150px] -ml-64 animate-pulse"></div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
         <div className="space-y-4 text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent-main/10 border border-accent-main/20 mb-2">
               ...
               <span className="text-[11px] font-black tracking-[0.2em] text-accent-main uppercase font-mono">Arena Command Center</span>
            </div>
            <Typography variant="h1" className="!text-6xl font-black tracking-tighter">
               Technical <span className="text-accent-main">Arena</span>
            </Typography>
         </div>
      </div>
    </>
